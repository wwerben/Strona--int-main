...
<html lang="pl">
  ...
  <body class="font-sans overflow-auto scrollbar-hide ">
    ...
    <!-- NIE MA SKALOWANIA DLA MOBILEK NAJELPIEJ SKALOWANIE INNE DLA LG W DOL -->
    ...
    <div class="flex flex-col lg:flex-row items-center w-full lg:w-auto">
      ...
      <!-- dorosli -->
      <input type="number" min="1" value="1" class="border border-gray-300 rounded p-2 w-full lg:w-32 text-gray-700 mb-2 lg:mb-0 lg:mr-4" placeholder="Dorośli">

      <!-- dzieci -->
      <input type="number" min="0" value="1" class="border border-gray-300 rounded p-2 w-full lg:w-32 text-gray-700" placeholder="Dzieci">
    </div>
      ...
      <div class="max-w-screen-2xl mx-4 py-12 lg:flex lg:justify-center lg:items-center">
        ...
        <div class="max-w-full mx-auto rounded-lg overflow-hidden mt-8 lg:mt-0">
          ...
          <div class="border-t border-gray-200 px-6 py-4">
            ...
            <p class="mt-1 text-gray-600">Email: titaniumtower@info.com</p>
            ...
            <p class="mt-1 text-gray-600">Telefon: +48 222 222 222</p>
          </div>
